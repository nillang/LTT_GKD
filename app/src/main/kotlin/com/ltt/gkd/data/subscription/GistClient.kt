package com.ltt.gkd.data.subscription

import com.ltt.gkd.data.rule.RuleSet
import com.ltt.gkd.util.Logger
import com.ltt.gkd.util.globalMoshi
import com.ltt.gkd.util.globalAdapter
...
class GistClient(
    ...
    private val client get() = com.ltt.gkd.util.HttpClientHolder.client
            ...
            client.newCall(req).execute().use { resp ->
                ...
                while (keys.hasNext()) {
                    ...
                    runCatching { globalAdapter<RuleSet>().fromJson(content) }
                        .onFailure { Logger.w("Gist 文件 $name JSON 解析失败", it) }
                        .getOrNull()
